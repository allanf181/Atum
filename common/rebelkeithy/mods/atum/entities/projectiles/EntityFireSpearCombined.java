...
public class EntityFireSpearCombined extends Entity implements IProjectile, IThrowableEntity {
   ...
   public EntityFireSpearCombined(World par1World) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.setSize(0.5F, 0.5F);
   }

   public EntityFireSpearCombined(World par1World, double par2, double par4, double par6) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.setSize(0.5F, 0.5F);
   ...
   public EntityFireSpearCombined(World par1World, EntityLivingBase par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
   ...
   public EntityFireSpearCombined(World par1World, EntityLivingBase par2EntityLiving, float par3) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.shootingEntity = par2EntityLiving;
      if(par2EntityLiving instanceof EntityPlayer) {
   ...
   public void onUpdate() {
      ...
      int var19 = super.worldObj.getBlockId(this.xTile, this.yTile, this.zTile);
      if(var19 > 0) {
         Block.blocksList[var19].setBlockBoundsBasedOnState(super.worldObj, this.xTile, this.yTile, this.zTile);
         AxisAlignedBB position = Block.blocksList[var19].getCollisionBoundingBoxFromPool(super.worldObj, this.xTile, this.yTile, this.zTile);
         if(position != null && position.isVecInside(super.worldObj.getWorldVec3Pool().getVecFromPool(super.posX, super.posY, super.posZ))) {
            this.inGround = true;
         }
      }
      ...
      if(this.inGround) {
         int var20 = super.worldObj.getBlockId(this.xTile, this.yTile, this.zTile);
         int new_position = super.worldObj.getBlockMetadata(this.xTile, this.yTile, this.zTile);
         if(var20 == this.inTile && new_position == this.inData) {
            ++this.ticksInGround;
         ...
         ++this.ticksInAir;
         Vec3 var21 = super.worldObj.getWorldVec3Pool().getVecFromPool(super.posX, super.posY, super.posZ);
         Vec3 var22 = super.worldObj.getWorldVec3Pool().getVecFromPool(super.posX + super.motionX, super.posY + super.motionY, super.posZ + super.motionZ);
         MovingObjectPosition movingobjectposition = super.worldObj.rayTraceBlocks_do_do(var21, var22, false, true);
         var21 = super.worldObj.getWorldVec3Pool().getVecFromPool(super.posX, super.posY, super.posZ);
         var22 = super.worldObj.getWorldVec3Pool().getVecFromPool(super.posX + super.motionX, super.posY + super.motionY, super.posZ + super.motionZ);
         if(movingobjectposition != null) {
            var22 = super.worldObj.getWorldVec3Pool().getVecFromPool(movingobjectposition.hitVec.xCoord, movingobjectposition.hitVec.yCoord, movingobjectposition.hitVec.zCoord);
         }
         ...
         for(l = 0; l < list.size(); ++l) {
            ...
            if(f2.canBeCollidedWith() && (f2 != this.shootingEntity || this.ticksInAir >= 5)) {
               ...
               MovingObjectPosition f4 = f3.calculateIntercept(var21, var22);
               if(f4 != null) {
                  prevMotionY = var21.distanceTo(f4.hitVec);
                  if(prevMotionY < d0 || d0 == 0.0D) {
                     entity = f2;
                     d0 = prevMotionY;
                  }
               }
         ...
         if(movingobjectposition != null && movingobjectposition.entityHit != null && movingobjectposition.entityHit instanceof EntityPlayer) {
            EntityPlayer var23 = (EntityPlayer)movingobjectposition.entityHit;
            if(var23.capabilities.disableDamage || this.shootingEntity instanceof EntityPlayer && !((EntityPlayer)this.shootingEntity).canAttackPlayer(var23)) {
         ...
         if(movingobjectposition != null) {
            if(movingobjectposition.entityHit != null) {
               var25 = MathHelper.sqrt_double(super.motionX * super.motionX + super.motionY * super.motionY + super.motionZ * super.motionZ);
               int var26 = MathHelper.ceiling_double_int((double)var25 * this.damage);
               if(this.getIsCritical()) {
                  var26 += super.rand.nextInt(var26 / 2 + 2);
               }

               DamageSource var28 = null;
               if(this.shootingEntity == null) {
                  var28 = DamageSource.causeThrownDamage(this, this);
               } else {
                  var28 = DamageSource.causeThrownDamage(this, this.shootingEntity);
               }
               ...
               if(movingobjectposition.entityHit.attackEntityFrom(var28, var26)) {
                  if(movingobjectposition.entityHit instanceof EntityLiving) {
                     ...
                     if(this.knockbackStrength > 0) {
                        var24 = MathHelper.sqrt_double(super.motionX * super.motionX + super.motionZ * super.motionZ);
                        if(var24 > 0.0F) {
                           movingobjectposition.entityHit.addVelocity(super.motionX * (double)this.knockbackStrength * 0.6000000238418579D / (double)var24, 0.1D, super.motionZ * (double)this.knockbackStrength * 0.6000000238418579D / (double)var24);
                        }
                     }
               ...
               var25 = MathHelper.sqrt_double(super.motionX * super.motionX + super.motionY * super.motionY + super.motionZ * super.motionZ);
               super.posX -= super.motionX / (double)var25 * 0.05D;
               super.posY -= super.motionY / (double)var25 * 0.05D;
               super.posZ -= super.motionZ / (double)var25 * 0.05D;
               this.playSound("random.bowhit", 1.0F, 1.2F / (super.rand.nextFloat() * 0.2F + 0.9F));
               this.inGround = true;
               this.arrowShake = 7;
         ...
         var25 = MathHelper.sqrt_double(super.motionX * super.motionX + super.motionZ * super.motionZ);
         super.rotationYaw = (float)(Math.atan2(super.motionX, super.motionZ) * 180.0D / 3.141592653589793D);

         for(super.rotationPitch = (float)(Math.atan2(super.motionY, (double)var25) * 180.0D / 3.141592653589793D); super.rotationPitch - super.prevRotationPitch < -180.0F; super.prevRotationPitch -= 360.0F) {
            ;
         }
         ...
         if(this.isInWater()) {
            for(int var29 = 0; var29 < 4; ++var29) {
               var24 = 0.25F;
               super.worldObj.spawnParticle("bubble", super.posX - super.motionX * (double)var24, super.posY - super.motionY * (double)var24, super.posZ - super.motionZ * (double)var24, super.motionX, super.motionY, super.motionZ);
            }

            var27 = 0.8F;
         }

         prevMotionY = super.motionY;
         super.motionX *= (double)var27;
         super.motionY *= (double)var27;
         super.motionZ *= (double)var27;
         super.motionY -= (double)f1;
         this.setPosition(super.posX, super.posY, super.posZ);
         if(Math.random() > 0.0D) {
            super.worldObj.spawnParticle("flame", super.posX + Math.random() * 0.5D - 0.25D, super.posY + Math.random() * 0.5D - 0.25D, super.posZ + Math.random() * 0.5D - 0.25D, 0.0D, 0.0D, 0.0D);
            super.worldObj.spawnParticle("smoke", super.posX + Math.random() * 0.5D - 0.25D, super.posY + Math.random() * 0.5D - 0.25D, super.posZ + Math.random() * 0.5D - 0.25D, 0.0D, 0.0D, 0.0D);
         }

         if(this.ticksInAir > 10 && super.motionY < 0.0D) {
            EntityFireSpearSeperated spear1 = new EntityFireSpearSeperated(this, 0.1F, 0.0F, 0.1F);
            EntityFireSpearSeperated spear2 = new EntityFireSpearSeperated(this, -0.1F, 0.0F, -0.1F);
            EntityFireSpearSeperated spear3 = new EntityFireSpearSeperated(this, 0.0F, 0.0F, 0.0F);
            if(!super.worldObj.isRemote) {
               super.worldObj.spawnEntityInWorld(spear1);
               super.worldObj.spawnEntityInWorld(spear2);
               super.worldObj.spawnEntityInWorld(spear3);
               this.setDead();
            }
         }
