...
public class EntityFireSpearSeperated extends Entity implements IProjectile, IThrowableEntity {
   ...
   public EntityFireSpearSeperated(EntityFireSpearCombined spear, float dmx, float dmy, float dmz) {
      super(spear.worldObj);
      this.setPosition(spear.posX, spear.posY, spear.posZ);
      super.renderDistanceWeight = spear.renderDistanceWeight;
      this.shootingEntity = spear.shootingEntity;
      this.canBePickedUp = spear.canBePickedUp;
      super.lastTickPosX = spear.lastTickPosX;
      super.lastTickPosY = spear.lastTickPosY;
      super.lastTickPosZ = spear.lastTickPosZ;
      super.rotationYaw = spear.rotationYaw;
      super.rotationPitch = spear.rotationPitch;
      super.motionX = spear.motionX + (double)dmx;
      super.motionY = spear.motionY + (double)dmy;
      super.motionZ = spear.motionZ + (double)dmz;
   }

   public EntityFireSpearSeperated(World par1World) {
      super(par1World);
   ...
   public EntityFireSpearSeperated(World par1World, double par2, double par4, double par6) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.setSize(0.5F, 0.5F);
   ...
   public EntityFireSpearSeperated(World par1World, EntityLivingBase par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
   ...
   public EntityFireSpearSeperated(World par1World, EntityLivingBase par2EntityLiving, float par3) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.shootingEntity = par2EntityLiving;
      if(par2EntityLiving instanceof EntityPlayer) {
         ...
         if(movingobjectposition != null) {
            if(movingobjectposition.entityHit != null) {
               ...
               if(this.shootingEntity == null) {
                  var24 = DamageSource.causeThrownDamage(this, this);
               } else {
                  var24 = DamageSource.causeThrownDamage(this, this.shootingEntity);
               }
               ...
               if(movingobjectposition.entityHit.attackEntityFrom(var24, var23)) {
