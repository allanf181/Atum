...
public class BlockAtumLeaves extends BlockLeavesBase implements IShearable {
   ...
   public int idDropped(int par1, Random par2Random, int par3) {
      return AtumBlocks.palmSapling.blockID;
   }
   ...
   public void setGraphicsLevel(boolean par1) {
      super.graphicsLevel = par1;
      this.graphicFlag = par1?0:1;
   }

   protected ItemStack createStackedBlock(int par1) {
      return new ItemStack(super.blockID, 1, par1 & 3);
   }

   @SideOnly(Side.CLIENT)
   public void registerIcons(IconRegister par1IconRegister) {
      this.icon = par1IconRegister.registerIcon("atum:AtumLeaves");
   }
