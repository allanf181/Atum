...
public class ItemBlockAtumSlab extends ItemBlock {
   ...
   public ItemBlockAtumSlab(int par1, BlockHalfSlab par2BlockHalfSlab, BlockHalfSlab par3BlockHalfSlab, boolean par4) {
      super(par1);
