...
public class BlockPapyrus extends Block implements IPlantable {
   ...
   public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
      if((double)par5Random.nextFloat() <= 0.75D) {
         if(par1World.isAirBlock(par2, par3 + 1, par4)) {
            int l;
            for(l = 1; par1World.getBlockId(par2, par3 - l, par4) == super.blockID; ++l) {
               ;
            }
            ...
            if(l < 5) {
               ...
               if(i1 >= reqHeight) {
                  par1World.setBlock(par2, par3 + 1, par4, super.blockID);
   ...
   public Icon getBlockTexture(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5) {
      boolean top = par1IBlockAccess.getBlockId(par2, par3 + 1, par4) != super.blockID;
   ...
   public boolean canSustainPlant(World world, int x, int y, int z, ForgeDirection direction, IPlantable plant) {
      ...
      if(plantID == AtumBlocks.papyrus.blockID && super.blockID == AtumBlocks.papyrus.blockID) {
         return true;
      } else if(plantType != EnumPlantType.Beach) {
         return false;
      } else {
         boolean isBeach = super.blockID == Block.grass.blockID || super.blockID == Block.dirt.blockID || super.blockID == Block.sand.blockID;
