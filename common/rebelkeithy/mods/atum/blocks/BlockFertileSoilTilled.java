...
public class BlockFertileSoilTilled extends Block {
   ...
   public Icon getIcon(int par1, int par2) {
      return par2 >> 3 == 0?(par1 == 1?(par2 > 0?this.field_94441_a:this.field_94440_b):AtumBlocks.fertileSoil.getIcon(par1, 1)):Block.tilledField.getIcon(par1, par2);
   }
   ...
   public int idDropped(int par1, Random par2Random, int par3) {
      return par1 >> 3 == 0?AtumBlocks.sand.blockID:Block.dirt.blockID;
   }
   ...
   public int idPicked(World par1World, int par2, int par3, int par4) {
      ...
      return type == 0?AtumBlocks.sand.blockID:Block.dirt.blockID;
   }
