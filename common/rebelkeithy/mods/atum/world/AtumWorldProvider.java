...
import rebelkeithy.mods.atum.world.AtumChunkProvider;
...
public class AtumWorldProvider extends WorldProvider {
   ...
   protected void registerWorldChunkManager() {
      super.worldChunkMgr = new WorldChunkManagerHell(Atum.atumDesert, 0.8F, 0.1F);
      super.dimensionId = AtumConfig.dimensionID;
   }
