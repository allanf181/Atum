...
public class EntityArrowDoubleShot extends CustomArrow implements IProjectile, IThrowableEntity {
   ...
   public EntityArrowDoubleShot(World par1World) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.setSize(0.5F, 0.5F);
   }

   public EntityArrowDoubleShot(World par1World, double par2, double par4, double par6) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.setSize(0.5F, 0.5F);
   ...
   public EntityArrowDoubleShot(World par1World, EntityLivingBase par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
   ...
   public void onUpdate() {
      ...
      if(this.inGround) {
         ...
         if(this.getIsCritical() && super.worldObj.isRemote) {
            for(l = 0; l < 4; ++l) {
               ParticleRegistry.spawnParticle("coloredcrit", super.worldObj, super.posX + super.motionX * (double)l / 4.0D, super.posY + super.motionY * (double)l / 4.0D, super.posZ + super.motionZ * (double)l / 4.0D, -super.motionX, -super.motionY + 0.2D, -super.motionZ, 0.7D, 1.0D, 0.7D);
            }
         }
   ...
   public String getTexture() {
      return "/mods/Atum/textures/projectiles/arrows_double.png";
   }
}
