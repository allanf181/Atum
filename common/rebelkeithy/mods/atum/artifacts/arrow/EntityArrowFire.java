...
public class EntityArrowFire extends CustomArrow implements IProjectile, IThrowableEntity {
   ...
   public EntityArrowFire(World par1World, double par2, double par4, double par6) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.setSize(0.5F, 0.5F);
   ...
   public EntityArrowFire(World par1World, EntityLivingBase par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
   ...
   public EntityArrowFire(World par1World, EntityLivingBase par2EntityLiving, float par3) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.shootingEntity = par2EntityLiving;
      if(par2EntityLiving instanceof EntityPlayer) {
      ...
      if(this.inGround) {
         ...
         if(var17 == this.inTile && vec31 == this.inData) {
            ...
            if(super.worldObj.isAirBlock((int)super.posX, (int)super.posY, (int)super.posZ)) {
               super.worldObj.setBlock((int)super.posX, (int)super.posY, (int)super.posZ, Block.fire.blockID);
            }
         ...
         if(this.getIsCritical() && super.worldObj.isRemote) {
            for(l = 0; l < 4; ++l) {
               ParticleRegistry.spawnParticle("coloredcrit", super.worldObj, super.posX + super.motionX * (double)l / 4.0D, super.posY + super.motionY * (double)l / 4.0D, super.posZ + super.motionZ * (double)l / 4.0D, -super.motionX, -super.motionY + 0.2D, -super.motionZ, 0.8D, 0.5D, 0.2D);
            }
         }
