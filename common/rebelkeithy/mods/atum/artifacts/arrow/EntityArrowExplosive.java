...
public class EntityArrowExplosive extends CustomArrow implements IProjectile, IThrowableEntity {
   ...
   public EntityArrowExplosive(World par1World) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.setSize(0.5F, 0.5F);
   }

   public EntityArrowExplosive(World par1World, double par2, double par4, double par6) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.setSize(0.5F, 0.5F);
   ...
   public EntityArrowExplosive(World par1World, EntityLivingBase par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
   ...
   public EntityArrowExplosive(World par1World, EntityLivingBase par2EntityLiving, float par3) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      this.shootingEntity = par2EntityLiving;
      if(par2EntityLiving instanceof EntityPlayer) {
   ...
   public void onUpdate() {
      ...
      if(var16 > 0) {
         ...
         if(vec3 != null && vec3.isVecInside(super.worldObj.getWorldVec3Pool().getVecFromPool(super.posX, super.posY, super.posZ))) {
            super.worldObj.newExplosion(this, super.posX, super.posY, super.posZ, 2.0F, this.isBurning(), true);
            this.inGround = true;
         }
      }
      ...
      if(this.inGround) {
         ...
         if(movingobjectposition != null) {
            if(movingobjectposition.entityHit != null) {
               ...
               super.worldObj.createExplosion(this, entity.posX, entity.posY, entity.posZ, 2.0F, true);
               this.setDead();
               ...
               this.playSound("random.bowhit", 1.0F, 1.2F / (super.rand.nextFloat() * 0.2F + 0.9F));
               super.worldObj.createExplosion(this, movingobjectposition.hitVec.xCoord, movingobjectposition.hitVec.yCoord, movingobjectposition.hitVec.zCoord, 2.0F, true);
               this.inGround = true;
               this.arrowShake = 7;
               this.setDead();
         ...
         if(this.getIsCritical() && super.worldObj.isRemote) {
            for(l = 0; l < 4; ++l) {
               ParticleRegistry.spawnParticle("coloredcrit", super.worldObj, super.posX + super.motionX * (double)l / 4.0D, super.posY + super.motionY * (double)l / 4.0D, super.posZ + super.motionZ * (double)l / 4.0D, -super.motionX, -super.motionY + 0.2D, -super.motionZ, 0.5D, 0.1D, 0.5D);
            }
         }

         if(Math.random() > 0.0D) {
            super.worldObj.spawnParticle("smoke", super.posX + super.motionX * (double)l / 4.0D, super.posY + super.motionY * (double)l / 4.0D, super.posZ + super.motionZ * (double)l / 4.0D, -super.motionX / 10.0D, (-super.motionY + 0.2D) / 10.0D, -super.motionZ / 10.0D);
         }
