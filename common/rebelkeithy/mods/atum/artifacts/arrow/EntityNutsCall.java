...
public class EntityNutsCall extends CustomArrow implements IProjectile, IThrowableEntity {
   ...
   public EntityNutsCall(World par1World) {
      super(par1World);
   ...
   public EntityNutsCall(World par1World, double par2, double par4, double par6) {
      super(par1World);
      super.renderDistanceWeight = 10.0D;
      super.isImmuneToFire = true;
      this.setSize(1.5F, 0.5F);
   ...
   public EntityNutsCall(World par1World, EntityLivingBase par2EntityLiving, float par3) {
      super(par1World);
      super.isImmuneToFire = true;
      super.renderDistanceWeight = 10.0D;
      this.shootingEntity = par2EntityLiving;
      ...
      if(this.inGround) {
         ...
         if(movingobjectposition != null) {
            if(movingobjectposition.entityHit != null) {
               ...
               if(Math.random() > 0.5D) {
                  super.worldObj.addWeatherEffect(new EntityLightningBolt(super.worldObj, super.posX, super.posY, super.posZ));
               }
   ...
   public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
      ...
      NBTTagCompound stackTag = par1NBTTagCompound.getCompoundTag("itemstack");
      this.stack = ItemStack.loadItemStackFromNBT(stackTag);
   }

   public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
      if(!super.worldObj.isRemote && this.inGround && this.arrowShake <= 0) {
         boolean flag = this.canBePickedUp == 1 || this.canBePickedUp == 2 && par1EntityPlayer.capabilities.isCreativeMode;
         if(this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(this.stack)) {
            flag = false;
         }
