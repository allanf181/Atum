   ...
   public void onUpdate() {
      ...
      if(this.inGround) {
         ...
         if(this.getIsCritical() && super.worldObj.isRemote) {
            for(l = 0; l < 4; ++l) {
               ParticleRegistry.spawnParticle("coloredcrit", super.worldObj, super.posX + super.motionX * (double)l / 4.0D, super.posY + super.motionY * (double)l / 4.0D, super.posZ + super.motionZ * (double)l / 4.0D, -super.motionX, -super.motionY + 0.2D, -super.motionZ, 0.2D, 0.2D, 0.2D);
            }
         }
         ...
         super.motionY -= Math.min(0.05D, (double)f1 / (super.motionX * super.motionX + super.motionZ * super.motionZ));
         this.setPosition(super.posX, super.posY, super.posZ);
