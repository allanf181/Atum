...
public class RendererItemBow implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		if (e instanceof EntityPlayer && ((EntityPlayer) e).username.equals(Minecraft.getMinecraft().thePlayer.username) && Minecraft.getMinecraft().gameSettings.thirdPersonView == 0) {
