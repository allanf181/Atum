...
public class ContainerLimestoneFurnace extends Container {
   ...
   public ContainerLimestoneFurnace(InventoryPlayer par1InventoryPlayer, TileEntity par2TileEntityLimestoneFurnace) {
      ...
      this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, this.furnace, 2, 116, 35));
   ...
   public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
      ...
      if(slot != null && slot.getHasStack()) {
         ...
         if(par2 == 2) {
            ...
            } else if(TileEntityLimestoneFurnace.isItemFuel(itemstack1)) {
