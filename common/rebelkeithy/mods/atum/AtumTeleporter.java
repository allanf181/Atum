...
import rebelkeithy.mods.atum.AtumPortalPosition;
			...
			for (k1 = l - short1; k1 <= l + short1; ++k1) {
				...
				for (int d9 = i1 - short1; d9 <= i1 + short1; ++d9) {
					...
					for (k2 = this.worldServerInstance.getActualHeight() - 1; k2 >= 0; --k2) {
						if (this.worldServerInstance.getBlockId(k1, k2, d9) == AtumBlocks.portal.blockID) {
							while (this.worldServerInstance.getBlockId(k1, k2 - 1, d9) == AtumBlocks.portal.blockID) {
								--k2;
							}
							...
							for (j3 = 0; j3 < 3; ++j3) {
								for (i4 = 0; i4 < 4; ++i4) {
									for (l3 = -1; l3 < 4; ++l3) {
										...
										j4 = k2 + l3;
										i5 = j2 + (i4 - 1) * k3 - j3 * l2;
										if (l3 < 0 && !this.worldServerInstance.getBlockMaterial(k4, j4, i5).isSolid() || l3 >= 0 && !this.worldServerInstance.isAirBlock(k4, j4, i5)) {
											continue label272;
										}
									}
								}
