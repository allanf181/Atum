...
public class AtumItems {
	...
	public static void init() {
		...
		date = (new ItemFood(AtumConfig.itemDateID, 5, 1.5F, false)).setTextureName("atum:Date").setUnlocalizedName("atum:Date").setCreativeTab(Atum.tabs);
		...
		greatsword = (new ItemGreatsword(AtumConfig.greatswordID, EnumToolMaterial.IRON)).setUnlocalizedName("atum:Greatsword").setTextureName("atum:Greatsword").setCreativeTab(Atum.tabs);
		...
		mummyHelmet = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.mummyHelmetID, mummyEnum, 0, 0)).setRepairItem(AtumConfig.clothScrapID + 256).setTextureFile("MummyArmor_1").setUnlocalizedName("atum:MummyHelmet").setTextureName("atum:MummyHelmet").setCreativeTab(Atum.tabs);
		mummyChest = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.mummyChestID, mummyEnum, 0, 1)).setRepairItem(AtumConfig.clothScrapID + 256).setTextureFile("MummyArmor_1").setUnlocalizedName("atum:MummyChest").setTextureName("atum:MummyChest").setCreativeTab(Atum.tabs);
		mummyLegs = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.mummyLegsID, mummyEnum, 0, 2)).setRepairItem(AtumConfig.clothScrapID + 256).setTextureFile("MummyArmor_2").setUnlocalizedName("atum:MummyLegs").setTextureName("atum:MummyLegs").setCreativeTab(Atum.tabs);
		mummyBoots = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.mummyBootsID, mummyEnum, 0, 3)).setRepairItem(AtumConfig.clothScrapID + 256).setTextureFile("MummyArmor_1").setUnlocalizedName("atum:MummyBoots").setTextureName("atum:MummyBoots").setCreativeTab(Atum.tabs);
		EnumArmorMaterial wandererEnum = EnumHelper.addArmorMaterial("Wanderer", 10, new int[] { 2, 3, 3, 2 }, 15);
		wandererHelmet = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.wandererHelmetID, wandererEnum, 0, 0)).setRepairItem(AtumConfig.linenID + 256).setTextureFile("WandererArmor_1").setUnlocalizedName("atum:WandererHelmet").setTextureName("atum:WandererHelmet").setCreativeTab(Atum.tabs);
		wandererChest = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.wandererChestID, wandererEnum, 0, 1)).setRepairItem(AtumConfig.linenID + 256).setTextureFile("WandererArmor_1").setUnlocalizedName("atum:WandererChest").setTextureName("atum:WandererChest").setCreativeTab(Atum.tabs);
		wandererLegs = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.wandererLegsID, wandererEnum, 0, 2)).setRepairItem(AtumConfig.linenID + 256).setTextureFile("WandererArmor_2").setUnlocalizedName("atum:WandererLegs").setTextureName("atum:WandererLegs").setCreativeTab(Atum.tabs);
		wandererBoots = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.wandererBootsID, wandererEnum, 0, 3)).setRepairItem(AtumConfig.linenID + 256).setTextureFile("WandererArmor_1").setUnlocalizedName("atum:WandererBoots").setTextureName("atum:WandererBoots").setCreativeTab(Atum.tabs);
		EnumArmorMaterial desertEnum = EnumHelper.addArmorMaterial("Desert", 20, new int[] { 3, 6, 5, 3 }, 15);
		desertHelmet = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.desertHelmetID, desertEnum, 0, 0)).setRepairItem(Item.ingotIron.itemID).setTextureFile("DesertArmor_1").setUnlocalizedName("atum:DesertHelmet").setTextureName("atum:DesertHelmet").setCreativeTab(Atum.tabs);
		desertChest = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.desertChestID, desertEnum, 0, 1)).setRepairItem(Item.ingotIron.itemID).setTextureFile("DesertArmor_1").setUnlocalizedName("atum:DesertChest").setTextureName("atum:DesertChest").setCreativeTab(Atum.tabs);
		desertLegs = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.desertLegsID, desertEnum, 0, 2)).setRepairItem(Item.ingotIron.itemID).setTextureFile("DesertArmor_2").setUnlocalizedName("atum:DesertLegs").setTextureName("atum:DesertLegs").setCreativeTab(Atum.tabs);
		desertBoots = (ItemTexturedArmor) (new ItemTexturedArmor(AtumConfig.desertBootsID, desertEnum, 0, 3)).setRepairItem(Item.ingotIron.itemID).setTextureFile("DesertArmor_1").setUnlocalizedName("atum:DesertBoots").setTextureName("atum:DesertBoots").setCreativeTab(Atum.tabs);
		...
		ectoplasm = (new Item(AtumConfig.ectoplasmID)).setUnlocalizedName("atum:Ectoplasm").setTextureName(Atum.modID + ":Ectoplasm").setCreativeTab(Atum.tabs);
		stoneChunk = (new Item(AtumConfig.stoneChunkID)).setUnlocalizedName("atum:StoneChunk").setTextureName("atum:StoneChunk").setCreativeTab(Atum.tabs);
		scrap = (new Item(AtumConfig.clothScrapID)).setUnlocalizedName("atum:ClothScrap").setTextureName("atum:ClothScrap").setCreativeTab(Atum.tabs);
		scroll = new Item(AtumConfig.scrollID).setUnlocalizedName("atum:Scroll").setTextureName("atum:Scroll").setCreativeTab(Atum.tabs);
		pelt = (new Item(AtumConfig.peltID)).setUnlocalizedName("atum:WolfPelt").setTextureName("atum:WolfPelt").setCreativeTab(Atum.tabs);
		linen = (new Item(AtumConfig.linenID)).setUnlocalizedName("atum:Linen").setTextureName("atum:Linen").setCreativeTab(Atum.tabs);
		flax = (new Item(AtumConfig.itemFlaxID)).setUnlocalizedName("atum:FlaxItem").setTextureName("atum:FlaxItem").setCreativeTab(Atum.tabs);
		flaxSeeds = (new ItemSeeds(AtumConfig.itemFlaxSeedsID, AtumBlocks.flax.blockID, Block.tilledField.blockID)).setUnlocalizedName("atum:FlaxSeeds").setTextureName("atum:FlaxSeeds").setCreativeTab(Atum.tabs);
