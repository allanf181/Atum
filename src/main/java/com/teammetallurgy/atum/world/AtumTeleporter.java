	...
	public boolean makePortal(Entity par1Entity) {
		...
		for (int x1 = -2; x1 < 3; x1++) {
			for (int z1 = -2; z1 < 3; z1++) {
				...
				this.worldServerInstance.setBlock(entityX + x1, posY, entityZ + z1, block);
			}
		}
		for (int x1 = -2; x1 < 3; x1++) {
			for (int z1 = -2; z1 < 3; z1++) {
				if (x1 == 2 || z1 == 2 || x1 == -2 || z1 == -2) {
					this.worldServerInstance.setBlock(entityX + x1, posY + 1, entityZ + z1, block);
				}
			}
		}
			...
			for (int x1 = -2; x1 < 3; x1++) {
				for (int z1 = -2; z1 < 3; z1++) {
					if ((x1 == 2 && z1 == 2) || (x1 == -2 && z1 == 2) || (x1 == 2 && z1 == -2) || (x1 == -2 && z1 == -2)) {
						this.worldServerInstance.setBlock(entityX + x1, posY + y1, entityZ + z1, block);
					}
				}
			}
		}
		...
		for (int x1 = -1; x1 < 2; x1++) {
			for (int z1 = -1; z1 < 2; z1++) {
				this.worldServerInstance.setBlock(x1 + entityX, posY + 1, z1 + entityZ, AtumBlocks.BLOCK_PORTAL);
			}
		}
