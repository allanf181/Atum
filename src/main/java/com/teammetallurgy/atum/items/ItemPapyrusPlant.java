...
public class ItemPapyrusPlant extends Item {

	private int spawnID;

	public ItemPapyrusPlant(int par1, Block par2Block) {
		super(par1);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		...
		if(i1 == Block.snow && (par3World.getBlockMetadata(par4, par5, par6) & 7) < 1) {
			par7 = 1;
		} else if(i1 != Block.vine && i1 != Block.tallGrass && i1 != Block.deadBush) {
			if(par7 == 0) {
				--par5;
			}
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.itemIcon = par1IconRegister.registerIcon("atum:PapyrusPlantItem");
	}
