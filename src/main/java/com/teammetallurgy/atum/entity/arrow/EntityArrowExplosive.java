        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    this.worldObj.createExplosion(this, entity.posX, entity.posY, entity.posZ, 2.0F, true);
                    ...
                    this.playSound("random.bowhit", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
                    this.worldObj.createExplosion(this, movingobjectposition.hitVec.xCoord, movingobjectposition.hitVec.yCoord, movingobjectposition.hitVec.zCoord, 2.0F, true);
                    this.inGround = true;
                    this.arrowShake = 7;
                    this.setDead();
