...
public class EntityBanditArcher extends EntityMob implements IRangedAttackMob, IAtumDayMob {
	...
	public EntityBanditArcher(World par1World) {
		...
		this.setCanPickUpLoot(this.rand.nextFloat() < equipmentDropChances[this.worldObj.difficultySetting.ordinal()]);
	...
	public void setCombatTask() {
		...
		if (itemstack != null && itemstack.getItem() == AtumItems.ITEM_BOW) {
	...
	public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLiving, float par2) {
		EntityArrow entityarrow = new EntityArrow(this.worldObj, this, par1EntityLiving, 1.6F, (float) (14 - this.worldObj.difficultySetting.ordinal() * 4));
