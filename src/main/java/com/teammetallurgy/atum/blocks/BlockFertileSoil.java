...
public class BlockFertileSoil extends Block {
	...
	public boolean canSustainPlant(IBlockAccess world, int x, int y, int z, ForgeDirection direction, IPlantable plant) {
		...
		case 6:
			return false;
		case 7:
			boolean hasWater = (world.getBlock(x - 1, y, z).getMaterial() == Material.water) || (world.getBlock(x + 1, y, z).getMaterial() == Material.water) || (world.getBlockMaterial(x, y, z - 1) == Material.water) || (world.getBlockMaterial(x, y, z + 1) == Material.water);
