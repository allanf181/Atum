...
public class BlockBurningTrap extends BlockContainer {
	...
	public float getBlockHardness(World par1World, int par2, int par3, int par4) {
		return par1World.getBlockId(par2, par3 + 1, par4) == AtumBlocks.BLOCK_LARGEBRICK && par1World.getBlockMetadata(par2, par3 + 1, par4) == 1 ? -1.0F : super.blockHardness;
	}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5) {
		...
		if(flag && !flag1) {
			par1World.scheduleBlockUpdate(par2, par3, par4, super, this.tickRate(par1World));
