...
public enum AtumBlocks {
	...
	public static final Block BLOCK_SLABS = new AtumBlockSlab(AtumIDS.BLOCK_SLABS_ID, false).setUnlocalizedName("atum:slab");
	public static final Block BLOCK_DOUBLESLAB = new AtumBlockSlab(AtumIDS.BLOCK_DOUBLE_SLAB_ID, true).setUnlocalizedName("atum:doubleSlab");
	...
	public static final Block BLOCK_DIAMONDORE = new BlockAtumOres(AtumIDS.BLOCK_DIAMONDORE_ID).setHarvestLevel("pickaxe", 0);//.setUnlocalizedName("atum:diamondOre").setTextureName("atum:AtumDiamond");
	...
	public void registerBlocks() {
		...
		Block.setBurnProperties(BLOCK_PLANKS, 5, 20);
		Block.setBurnProperties(BLOCK_LEAVES, 30, 60);
