...
public class BlockPalmSapling extends BlockFlower {
	...
	protected boolean canThisPlantGrowOnThisBlockID(int id) {
		return id == AtumBlocks.BLOCK_SAND || id == Block.grass || id == Block.dirt;
	}

	@Override
	public boolean canBlockStay(World world, int x, int y, int z) {
		return world.getBlockId(x, y - 1, z) == AtumBlocks.BLOCK_SAND || world.getBlockId(x, y - 1, z) == Block.grass || world.getBlockId(x, y - 1, z) == Block.dirt;
	}
