...
public abstract class CursedChestBaseLogic extends MobSpawnerBaseLogic {
	...
	public Entity func_98265_a(Entity par1Entity) {
		if (this.getRandomEntity() != null) {
			...
			Iterator iterator = this.getRandomEntity().field_98222_b.getTags().iterator();
	...
	public void readFromNBT(NBTTagCompound par1NBTTagCompound) {
		...
		if (par1NBTTagCompound.hasKey("SpawnData")) {
			this.setRandomEntity(new WeightedRandomMinecart(this, par1NBTTagCompound.getCompoundTag("SpawnData"), this.mobID));
		} else {
	...
	public void writeToNBT(NBTTagCompound par1NBTTagCompound) {
		...
		if (this.getRandomEntity() != null) {
			par1NBTTagCompound.setCompoundTag("SpawnData", (NBTTagCompound) this.getRandomEntity().field_98222_b.copy());
		}
