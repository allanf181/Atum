...
public class BiomeDecoratorAtum extends BiomeDecorator {
	...
	public BiomeDecoratorAtum() {
		...
		this.gravelAsSandGen = new WorldGenSand(6, Blocks.gravel);
		this.dirtGen = new WorldGenMinable(Block.dirt, 32);
		this.gravelGen = new WorldGenMinable(Block.gravel, 32);
		...
		this.plantYellowGen = new WorldGenFlowers(Block.plantYellow);
		this.plantRedGen = new WorldGenFlowers(Block.plantRed);
		this.mushroomBrownGen = new WorldGenFlowers(Block.mushroomBrown);
		this.mushroomRedGen = new WorldGenFlowers(Block.mushroomRed);
	...
	protected void decorate() {
		...
		if(doGen && this.generateLakes) {
			for(j = 0; j < 20; ++j) {
				...
				i1 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				time = System.nanoTime();
				(new WorldGenLiquids(Block.lavaMoving)).generate(this.currentWorld, this.randomGenerator, k, l, i1);
			}
		}
