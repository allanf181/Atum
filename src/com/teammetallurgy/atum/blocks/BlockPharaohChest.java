...
public class BlockPharaohChest extends BlockContainer {
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLiving, ItemStack par6ItemStack) {
		...
		if(l != super.blockID && i1 != super.blockID && j1 != super.blockID && k1 != super.blockID) {
			par1World.setBlockMetadataWithNotify(par2, par3, par4, b0, 3);
		} else {
			if((l == super.blockID || i1 == super.blockID) && (b0 == 4 || b0 == 5)) {
				if(l == super.blockID) {
			...
			if((j1 == super.blockID || k1 == super.blockID) && (b0 == 2 || b0 == 3)) {
				if(j1 == super.blockID) {
	...
	public IInventory getInventory(World par1World, int par2, int par3, int par4) {
		TileEntityPharaohChest object = (TileEntityPharaohChest) par1World.getBlockTileEntity(par2, par3, par4);
	...
	public TileEntity createNewTileEntity(World par1World) {
		TileEntityPharaohChest tileEntityPharaoh = new TileEntityPharaohChest();
		return tileEntityPharaoh;
	}
