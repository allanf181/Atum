...
public class BlockSandLayered extends Block {
	...
	public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
		...
		return block == null ? false : (block.blockID == this.blockID ? true : (block == this && (par1World.getBlockMetadata(par2, par3 - 1, par4) & 7) == 7 ? true : (!block.isLeaves(par1World, par2, par3 - 1, par4) && !Block.blocksList[l].isOpaqueCube() ? false : par1World.getBlockMaterial(par2, par3 - 1, par4).blocksMovement())));
	}
