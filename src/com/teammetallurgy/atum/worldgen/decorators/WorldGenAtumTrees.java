...
public class WorldGenAtumTrees extends WorldGenerator {
	...
	private void genTreeLayer(int par1, int par2, int par3, float par4, byte par5, int par6) {
	...
	private void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, int par3) {
